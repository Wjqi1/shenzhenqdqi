                            ...
                            <ul>
                                <li  v-for='item in goodsdata.catelist' :key='item.id'>
                                    <h3>
                                        ...
                                        <p>
                                            <span v-for='itemsub in item.subcates'>
                                                {{itemsub.title}}&nbsp;
                                            </span>
                                    ...
                                    <div class="item-box">
                                        <dl>
                                            ...
                                            <dd>
                                                <a href="/goods/43.html" v-for='itemsub in item.subcates' :key='itemsub.id'>{{itemsub.title}}</a>
                    ...
                    <div class="left-705">
                        <div class="banner-img">
                            ...
                            <div id="focus-box" class="focus-box">
                                <el-carousel :interval="1000" arrow="always"  height="341px">
