(function(z) {
    var K = function(h, b, f, n) {
        ...
        G = function(h, b, f, n, c) { f = Math.max(1, f || 1);
            for (n = Math.min(40, n || 40); f <= n; f += 1) try {
                return new K(h, b, f, c) } catch (p) {} },
    ...
    var J = function() {
        function h(b, f) {
            ...
            var a = function() {
                    ...
                    return g }(),
                d = { get: function(d) {
                        return a[d] }, getLength: function() {
                        return a.length }, multiply: function(y) {
        ...
        var b = function(b, c) {
            var a = f[c],
                ...
                A = {},
                B = function(A, f) {
                    for (var r = y = 4 * b + 17, l = Array(r), c = 0; c < r; c += 1) { l[c] = Array(r);
                    ...
                    if (null == g) { r = p.getRSBlocks(b, a);
                        ...
                        for (; !(l.getLengthInBits() >= 8 * m);) { l.put(236, 8);
            ...
            A.getModuleCount = function() {
                return y };
            A.make = function() {
                for (var d = 0, e = 0, a = 0; 8 > a; a += 1) { B(!0, a);
                    var g = n.getLostPoint(A);
                    if (0 == a || d > g) d = g, e = a }
                B(!1, e) };
            A.createTableTag = function(d, a) { d = d || 2;
                var e;
                ...
                e += '">';
                e += "<tbody>";
                for (var g = 0; g < A.getModuleCount(); g += 1) { e += "<tr>";
                ...
                e += "</tbody>";
                return e += "</table>" };
            A.createImgTag = function(e, d) { e = e || 2;
        ...
        var f = { L: 1, M: 0, Q: 3, H: 2 },
                ...
                m.getLengthInBits = function(d, a) {
                    if (1 <= a && 10 > a) switch (d) {
                        ...
                        case 8:
                            return 10;
                        default:
                            throw Error("mode:" + d); } else if (41 > a) switch (d) {
                        case 1:
                            return 14;
                        case 2:
                            return 13;
                        ...
                        case 8:
                            return 12;
                        default:
                            throw Error("mode:" + d); } else throw Error("type:" + a);
                };
            ...
            v = function() {
                var b = [],
                    ...
                    a = { getBuffer: function() {
                            ...
                            return 1 == (b[Math.floor(a / 8)] >>> 7 - a % 8 & 1) }, put: function(b, c) {
                            for (var g = 0; g < c; g += 1) a.putBit(1 == (b >>> c - g - 1 & 1)) }, getLengthInBits: function() {
                            return c }, putBit: function(a) {
            ...
            k = function(c) {
                ...
                return { getMode: function() {
                        return 4 }, getLength: function(a) {
                        return m.length }, write: function(a) {
                        for (var b = 0; b < m.length; b += 1) a.put(m[b], 8) } } },
            x = function() {
                var b = [],
                    c = { writeByte: function(a) { b.push(a & 255) }, writeShort: function(a) { c.writeByte(a);
                            c.writeByte(a >>> 8) }, writeBytes: function(a, b, f) { b = b || 0;
                            f = f || a.length;
                            for (var g = 0; g < f; g += 1) c.writeByte(a[g + b]) }, writeString: function(a) {
                            for (var b = 0; b < a.length; b += 1) c.writeByte(a.charCodeAt(b)) }, toByteArray: function() {
                ...
                var b = 0,
                    ...
                    g = function(a) {
                        if (!(0 > a)) {
                            ...
                            if (63 == a) return 47 }
                        throw Error("n:" + a); };
                f.writeByte = function(e) { b = b << 8 | e & 255;
                    c += 8;
                    for (a += 1; 6 <= c;) d += String.fromCharCode(g(b >>> c - 6 & 63)), c -= 6 };
                f.flush = function() { 0 < c && (d += String.fromCharCode(g(b << 6 - c & 63)), c = b = 0);
                    if (0 != a % 3)
                    ...
                    f = function() {
                        var a = {},
                            ...
                            c = { add: function(d) {
                                    ...
                                    a[d] = b;
                                    b += 1 }, size: function() {
                                    return b }, indexOf: function(b) {
                                    return a[b] }, contains: function(b) {
                                    return "undefined" != typeof a[b] } };
                        return c };
                return { setPixel: function(c, d, f) { a[d * b + c] = f }, write: function(g) { g.writeString("GIF87a");
                        g.writeShort(b);
                        g.writeShort(c);
                        g.writeByte(128);
                        g.writeByte(0);
...
(function(f) {
    f.fn.erweima = function(a) {
        ...
        a = f.extend({ render: "canvas", ecLevel: "H", minVersion: 6, fill: "#666", background: "#fff", text: "http://www.jq22.com", size: 300, radius: .5, quiet: 4, mode: 2, mSize: .1, mPosX: .5, mPosY: .5, label: "\u626b\u7801\u5173\u6ce8\u6211", fontname: "Microsoft YaHei", fontcolor: "orange" }, a);
